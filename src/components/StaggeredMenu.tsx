...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // The panel is only off-screen once the line above has run. Until then it
      // sits open across the page, so CSS keeps it hidden until this flag says
      // the positioning is done. See globals.css.
      panel.closest('.sm-scope')?.setAttribute('data-ready', '');
    });
    return () => ctx.revert();
